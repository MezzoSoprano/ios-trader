...
//  BinanceAPI
//
//  Created by Svyatoslav Katola on 17/05/2020.
//
...
//        params["timeInForce"] = TimeInForce.gtc.rawValue
    ...
    public func aggregatedTrades(symbol: String, limit: Int = 500, fromId: Int? = nil,
                                 startTimestamp: Int? = nil, endTimestamp: Int? = nil, success: SuccessCallback<[AggregatedTrade]>? = nil, failure: FailureCallback? = nil) {
        var params: [String: Any] = ["symbol": symbol, "limit": limit]
        if let fromId = fromId {
            params["fromId"] = fromId
        }
    ...
    public func candlesticks(symbol: String, interval: CandlestickInterval = .hour4, limit: Int = 500,
                             startTimestamp: Int? = nil, endTimestamp: Int? = nil, success: SuccessCallback<[Candlestick]>? = nil, failure: FailureCallback? = nil) {
